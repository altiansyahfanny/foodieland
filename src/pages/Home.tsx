					...
					<div className="p-12">
						...
						<div className="mt-8 flex items-center gap-4">
							<button className="bg-black bg-opacity-5 rounded-full px-4 py-2 flex items-center gap-2.5">
								<img src={Timer} />
								<span className="font-semibold text-sm text-black text-opacity-60">30 Minutes</span>
							</button>
							<button className="bg-black bg-opacity-5 rounded-full px-4 py-2 flex items-center gap-2.5">
								<img src={ForkKnife} />
				...
				<div className="mt-36">
					<div className="flex items-center gap-10">
						<div className="relative w-[180px] h-[152px] rounded-[30px] bg-gradient-to-t from-[#7082461a] to-[#70824600]">
							<div className="absolute mx-auto -top-14 inset-x-0 flex justify-end">
								<img src={Breakfast} />
							</div>
			...
			<section className="mt-40 px-20">
				...
				<div className="mt-20 grid grid-cols-3 gap-10">
					<div className="bg-gradient-to-t from-[#E7F9FD] to-[#E7F9FD00] px-4 pb-4 rounded-3xl">
						...
						<p className="font-semibold text-2xl mt-6">Big and Juicy Wagyu Beef Cheeseburger</p>
					...
					<div className="bg-gradient-to-t from-[#E7F9FD] to-[#E7F9FD00] px-4 pb-4 rounded-3xl">
						...
						<p className="font-semibold text-2xl mt-6">Fresh and Healthy Mixed Mayonnaise Salad</p>
						<div className="flex items-center gap-6 mt-8">
							<div className="flex items-center gap-2.5">
								<img src={Timer} />
								<span className="font-semibold text-sm">30 Minutes</span>
					...
					<div className="bg-gradient-to-t from-[#E7F9FD] to-[#E7F9FD00] px-4 pb-4 rounded-3xl">
						...
						<p className="font-semibold text-2xl mt-6">Chicken Meatballs with Cream Cheese</p>
						<div className="flex items-center gap-6 mt-8">
							<div className="flex items-center gap-2.5">
								<img src={Timer} />
								<span className="font-semibold text-sm">30 Minutes</span>
					...
					<div className="bg-gradient-to-t from-[#E7F9FD] to-[#E7F9FD00] px-4 pb-4 rounded-3xl">
						...
						<p className="font-semibold text-2xl mt-6">Fruity Pancake with Orange & Blueberry</p>
						<div className="flex items-center gap-6 mt-8">
							<div className="flex items-center gap-2.5">
								<img src={Timer} />
								<span className="font-semibold text-sm">30 Minutes</span>
					...
					<div className="bg-gradient-to-t from-[#E7F9FD] to-[#E7F9FD00] px-4 pb-4 rounded-3xl">
						...
						<p className="font-semibold text-2xl mt-6">The Best Easy One Pot Chicken and Rice</p>
						<div className="flex items-center gap-6 mt-8">
							<div className="flex items-center gap-2.5">
								<img src={Timer} />
								<span className="font-semibold text-sm">30 Minutes</span>
